...
export const ACTION_THEMES: Record<Action, ActionTheme> = {
  reply: {
    ...
    resultGlow: "bg-gradient-to-b from-indigo-950/40 to-zinc-900/60 shadow-inner shadow-indigo-950/40",
  ...
  grammar: {
    ...
    resultGlow: "bg-gradient-to-b from-emerald-950/40 to-zinc-900/60 shadow-inner shadow-emerald-950/40",
  ...
  rewrite: {
    ...
    resultGlow: "bg-gradient-to-b from-amber-950/40 to-zinc-900/60 shadow-inner shadow-amber-950/40",
