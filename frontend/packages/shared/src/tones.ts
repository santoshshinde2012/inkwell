...
export const TONE_PRESETS = ["professional", "friendly", "concise", "detailed"] as const;
...
export const TONE_PRESET_PROMPTS: Record<TonePreset, string> = {
  ...
  concise: "Be brief. Strip filler. Prefer short sentences. Get to the point on the first line.",
  detailed:
