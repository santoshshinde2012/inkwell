 ...
 */
export const detectLanguage = async (text: string): Promise<DetectionResult | null> => {
  ...
  try {
    const result = await new Promise<chrome.i18n.LanguageDetectionResult>((resolve, reject) => {
