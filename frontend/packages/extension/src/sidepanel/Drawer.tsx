...
import { DropIcon, ExternalLinkIcon, GearIcon, HistoryIcon, SparkleIcon, XIcon } from "./icons";
...
export function Drawer({
  ...
  const initial = (displayName || "I").trim().charAt(0).toUpperCase() || "I";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <header id={titleId} className="flex items-center justify-end px-3 pt-3">
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-4 pt-2">
          <ProfileCard initial={initial} displayName={displayName} backendStatus={backendStatus} />
