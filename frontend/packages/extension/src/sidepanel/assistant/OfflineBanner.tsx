  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="text-[12px] font-semibold text-red-100">Backend is offline</div>
        <p className="mt-0.5 text-[11px] leading-relaxed text-red-200/80">
          Generations will fail until it's reachable. Check the URL and API key, or switch to your
          own backend.
        </p>
        <button
          type="button"
